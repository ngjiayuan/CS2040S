...
public class TSPMap {
	...
	/**
	 * setLinks
	 * @param a ArrayList describing how to set each link.
	 *          If a point's outgoing link is not described, its link is erased.
	 */
	public void setLinks(ArrayList<Integer> links, boolean redraw) {
		int i = 0;
		for (; i < links.size() && i < m_points.size(); i++) {
			setLink(i, links.get(i), false);
		}
	...
	public static void main(String[] args){
		// Open a new map
		TSPMap map = new TSPMap("C:/Users/ngjia/Desktop/ps8/hundredpoints.txt");
